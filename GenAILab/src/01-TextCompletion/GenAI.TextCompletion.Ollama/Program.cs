...
//Create a chat client using the OllamaSharp library
IChatClient client = new OllamaApiClient(new Uri("http://localhost:11434"), "llama3.2:3b");
...
//var response = client.GetStreamingResponseAsync("Hello, can you tell me a long joke?");
...
//var response = await client.GetResponseAsync(classificationPrompt);
...
#region Text Completion App With History
...
while (true)
{
    //Take user Input and add to chat history
